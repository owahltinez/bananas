...
@random_seeded
def generate_array_chars(n: int = 1024, vocab: list = None, random_seed: int = None) -> ARRAY_LIKE:
...
@random_seeded
def generate_array_ints(n: int = 1024, max_int: int = 256, random_seed: int = None) -> ARRAY_LIKE:
    """ Generate an array of size `n` and type `int`. """
    return _RNG.randint(0, max_int, n).astype(int)


@random_seeded
def generate_array_uints(n: int = 1024, max_int: int = 256, random_seed: int = None) -> ARRAY_LIKE:
...
@random_seeded
def generate_onehot_matrix(n: int = 1024, ndim: int = 8, random_seed: int = None) -> ARRAY_LIKE:
    """
