...
class Feature(object):
    ...
    def __init__(self, values: ARRAY_LIKE, kind: DataType = None, name: str = None,
                 ...
                 sample_size: int = SAMPLE_SIZE_SMALL, sampling_method: SamplingStrategy = None,
                 **sampling_kwargs):
        '''
        Parameters
        ----------
        ...
        assert hasattr(values, '__getitem__'), \
    ...
    def ix(self, key: Any, replace_strategy: ReplaceStrategy = None):
        ...
        not_replaceable_kind = (
            DataType.ONEHOT, DataType.HIGH_DIMENSIOAL, DataType.IMAGE_PATH)
