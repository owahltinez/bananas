...
class TestUtils(ProfilingTestCase):
                ...
                "steps": [
                    PipelineStep(
                        ...
                        kwargs={
                            "steps": [
                                PipelineStep(
                                    name="1", learner=CustomEstimator, kwargs={"a": 1, "b": "x"}
                                )
                            ]
                        },
                    )
                ...
                "steps": [
                    PipelineStep(
                        ...
                        kwargs={
                            "steps": [
                                PipelineStep(
                                    name="1", learner=CustomEstimator, kwargs={"a": 1, "b": "y"}
                                )
                            ]
                        },
                    )
                ...
                "steps": [
                    PipelineStep(
                        ...
                        kwargs={
                            "steps": [
                                PipelineStep(
                                    name="1", learner=CustomEstimator, kwargs={"a": 1, "b": "z"}
                                )
                            ]
                        },
                    )
                ...
                "steps": [
                    PipelineStep(
                        ...
                        kwargs={
                            "steps": [
                                PipelineStep(
                                    name="1", learner=CustomEstimator, kwargs={"a": 2, "b": "x"}
                                )
                            ]
                        },
                    )
                ...
                "steps": [
                    PipelineStep(
                        ...
                        kwargs={
                            "steps": [
                                PipelineStep(
                                    name="1", learner=CustomEstimator, kwargs={"a": 2, "b": "y"}
                                )
                            ]
                        },
                    )
                ...
                "steps": [
                    PipelineStep(
                        ...
                        kwargs={
                            "steps": [
                                PipelineStep(
                                    name="1", learner=CustomEstimator, kwargs={"a": 2, "b": "z"}
                                )
                            ]
                        },
                    )
                ...
                "steps": [
                    PipelineStep(
                        ...
                        kwargs={
                            "steps": [
                                PipelineStep(
                                    name="1", learner=CustomEstimator, kwargs={"a": 3, "b": "x"}
                                )
                            ]
                        },
                    )
                ...
                "steps": [
                    PipelineStep(
                        ...
                        kwargs={
                            "steps": [
                                PipelineStep(
                                    name="1", learner=CustomEstimator, kwargs={"a": 3, "b": "y"}
                                )
                            ]
                        },
                    )
                ...
                "steps": [
                    PipelineStep(
                        ...
                        kwargs={
                            "steps": [
                                PipelineStep(
                                    name="1", learner=CustomEstimator, kwargs={"a": 3, "b": "z"}
                                )
                            ]
                        },
                    )
    ...
    def test_grid_search_learner(self):
        ...
        result = [
            {"a": getattr(learner, "a"), "b": getattr(learner, "b")}
